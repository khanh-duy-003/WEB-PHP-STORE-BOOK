                                     ...
                                     <td class="text-center">
                                        <div class="function_style">
                                           <?php if ($topic->status == 1):?>
                                              <a href="index.php?opt=topic&cat=status&id=<?=$topic->id?>" class="btn btn-sm btn-success mx-1" title="Kích hoạt">
                                                 <i class="fa fa-toggle-on"></i>
                                              </a>
                                           <?php else:?>
                                              <a href="index.php?opt=topic&cat=status&id=<?=$topic->id?>" class="btn btn-sm btn-danger mx-1" title="Tạm ngưng">
                                                 <i class="fa fa-toggle-off"></i>
                                              </a>
                                           <?php endif;?>
                                           <a href="index.php?opt=topic&cat=edit&id=<?=$topic->id?>" class="btn btn-sm btn-primary mx-1" title="Sửa">
                                              <i class="fa fa-edit"></i>
                                           </a>
                                           <a href="index.php?opt=topic&cat=show&id=<?=$topic->id?>" class="btn btn-sm btn-info mx-1" title="Chi tiết">
                                              <i class="fa fa-eye text-white"></i>
                                           </a>
                                           <a href="index.php?opt=topic&cat=delete&id=<?=$topic->id?>" class="btn btn-sm btn-danger mx-1 btn-delete-js" title="Xóa">
